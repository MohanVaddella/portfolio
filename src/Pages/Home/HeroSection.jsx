      ...
      <div className="hero--section--content--box">
        <div className="hero--section--content">
          ...
          <span className="hero--section-description">
            I am an enthusiastic techie specializing in <b>Cloud Computing</b>{" "}
            and <b>Web Development</b>, demonstrating proficiency in designing
        ...
        <div className="footer--social--icon">
          ...
          <li>
            ...
            <li>
  <a
    href="https://linktr.ee/mohanvaddella"
    className="navbar--content"
    target="_blank"
    rel="noreferrer"
  >
