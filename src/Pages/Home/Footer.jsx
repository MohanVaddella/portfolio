  ...
  return (
    <footer className="footer--container">
      ...
      <span className="text-lg"><b>Mohan</b></span>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/mohan.vaddella/"
            ...
            <li>
              <a
                href="https://www.instagram.com/mohanvaddella25/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/mohanvaddella"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/mohanvaddella/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by <b>Mohan</b></p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
